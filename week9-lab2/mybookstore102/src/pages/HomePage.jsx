        ...
        <div className="container mx-auto px-4 py-24">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/books" 
                className="inline-flex items-center justify-center px-8 py-3 bg-yellow-300
                text-viridian-600 font-semibold rounded-lg hover:bg-gray-10 
              ...
              <Link to="/categories" 
                ...
                border-2 border-gray-100 text-black font-semibold rounded-lg 
                hover:bg-yellow-300 hover:text-viridian-600 transition-all duration-200">
                ดูหมวดหมู่ทั้งหมด
              </Link>
            </div>
          </div>
